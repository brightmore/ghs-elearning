                        ...
                        <div class="box-body">
                            ...
                            <form action="#" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="field">
                                        <input name="subject_name" id="subject_id" type="text"  class="xxwide text input validate[required] form-control" placeholder="Subject name" value="<?php echo $subject_id; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Course</label>
