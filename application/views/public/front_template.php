...
<html>
    ...
    <body>
        <div >
            <div class="" style="background-color: #31ba00;">
                <div class="row">
            ...
            <div class="row" id="wrapper">
                <div class="col-lg-9 col-md-9 col-sm-12" id="main-container">
                    <div class="logos" style="height: 70px; ">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 e-logo" id="eleaning-logo">
                                <img src="<?php echo base_url() ?>assets/img/e-learning-LOGO.png" />
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 e-logo " id="ghs-logo">
                                <img src="<?php echo base_url() ?>assets/img/GHS-logo.png" width="50" class="pull-right"/>
                            </div>
                        </div>

                    </div>
                    <div class="toolbar row" style="height: 3em;background-color: #31ba00; position: relative">
