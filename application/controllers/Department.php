<?php
    ...
    function index(){
        ...
        $this->load->view('list_department');
 ...
 /**
     ...
     */
         public function edit($id=0) {
                 ...
                 $data['id']= $id;
		if($id!=0){
			$result =  $this->department_model->findByPk($id);
			if(empty($result))
     ...
     */
      public function process_form(){
		...
		$data = array();
                        ...
                        $this->form_validation->set_rules("head", "head", "required|xss_clean"); 
          ...
          }else{   $id = $this->input->post('id');$department_name= $this->input->post('department_name');
                    $head= $this->input->post('head');
                    $phone= $this->input->post('phone');
                     $data_inser_array = array(  'department_name'=>$department_name,
                         'head'=>$head,
                         'phone'=>$phone,
                         );  
        ...
        if(isset($id) && !empty($id)){
           ...
           // $insert = $this->department_model->update('department',$data_inser_array,$condition);
            $insert = $this->db->update('department',$data_inser_array,$condition);
            $data = "Data Updated Successfully.";
            $this->session->set_flashdata('smessage',"Data Updated Successfully");
            $message['is_redirect'] =true;
          }else{
            //$insert = $this->department_model->create('department',$data_inser_array);
            $insert = $this->db->insert('department',$data_inser_array);
            $message['is_redirect'] =true;
		...
		$config["total_rows"] = $this->department_model->count_all_rows($search);
		...
		$arr = $this->department_model->get_data($sort_col,$sort_dir,$limit,$start,$search);
...
public function remove_form() {
        ...
        if (!empty($pid)) {
           ...
           // $params = array("is_active" => 0);
            ...
            $insert = $this->db->delete("department", $condition);
